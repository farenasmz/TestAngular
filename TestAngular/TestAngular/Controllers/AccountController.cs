    ...
    public class AccountController : ControllerBase
    {
        ...
        public async Task<IActionResult> PutUser([FromBody] User user)
        {
            ...
            try
            {
                ...
                {
                    tmpUser = await Repository.GetByEmail(user.Email);
        ...
        private IActionResult BuildToken(User User)
        {
            ...
            SecurityLoginDto login = new SecurityLoginDto();
            ...
            login.IsActive = User.isActive;
            login.Rol = User.Rol;
            login.WebToken = tokenResult.token;
            login.expiration = tokenResult.expiration;
